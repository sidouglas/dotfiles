#!/bin/bash
echo '<<< This will require a restart to take effect >>>'
# from https://superuser.com/a/1688991
# We need to disable Spotlight so Raycast/Afred etc can bind to apple + space.
set -e
